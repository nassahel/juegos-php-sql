...
if ($conexion && !empty($_GET['id'])) {
    ...
    if ($cantFilas > 0) {
        ...
        while (mysqli_stmt_fetch($sentencia)) {
            echo '<p class="mb-4">Esta seguro de <strong> desactivar </strong> al usuario <strong>' . $usuario . '</strong>?</p>';
            echo '<section class="mb-4"><a class="btn btn-success me-2" href="ejecutar_desactivar.php?id=' . $id . '">Aceptar</a>';
